...
#{"scope":["openid"],"client_id":"jupyterapp2","resource_ids":["none"],"authorized_grant_types":["refresh_token","authorization_code"],"redirect_uri":["https://frasepviya35vm1.cloud.com:8443/hub/oauth_callback"],"autoapprove":["true"],"access_token_validity":1296000,"authorities":["uaa.none"],"lastModified":1662572103811,"required_user_groups":[]}
