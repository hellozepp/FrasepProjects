...
%let inputProfileTable=departments_nir_profile ; /* the profiling result table */
...
%let append_master=no ; /* yes/no if you want to append the results - set no the first time to create/overwrite the tables */
