...
#  Default: 'http://:8000'
c.JupyterHub.bind_url = 'http://:8443'
...
#  Default: ''
c.JupyterHub.ssl_cert = '/opt/anaconda3/envs/jupyterhub/etc/jupyterhub/ssl-certs/certificate.pem'

## Path to SSL key file for the public facing interface of the proxy
#  
#          When setting this, you should also set ssl_cert
#  Default: ''
c.JupyterHub.ssl_key = '/opt/anaconda3/envs/jupyterhub/etc/jupyterhub/ssl-certs/key.pem'
